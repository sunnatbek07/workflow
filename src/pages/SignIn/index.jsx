            ...
            <div className='content'>
                ...
                <form action="" onChange={onFinish}>
                    ...
                    <div className='password'>
                        ...
                        <input required placeholder='Enter your password' type={showPassword ? "text" : "password"} />
                        <i class={showPassword ? "bx bx-show" : 'bx bx-low-vision'} onClick={() => setShowPassword(!showPassword)}></i>
                    </div>

                    <p className='text1'>Mot de passe oublié ?</p>
                    ...
                    <p className='lastText'>Vous n’avez pas de compte ? <Link to='/signup' className='link'>Créer un compte</Link></p>
                </form>
            </div>
        </div>
    )
